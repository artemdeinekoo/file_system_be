...
class Folder(models.Model):
    ...
    parentFolderId = models.ForeignKey('self', on_delete=models.CASCADE, null=True, blank=True, default=None, related_name='childFolders')
...
class File(models.Model):
    ...
    parentFolderId = models.ForeignKey(Folder, on_delete=models.CASCADE, null=True, blank=True,  default=None, related_name='childFiles')
    createdAt = models.DateTimeField(auto_now_add=True)
    updatedAt = models.DateTimeField(auto_now=True)
